    ...
    <>
      ...
      <main>
        ...
        <section className="relative pt-28 pb-16 sm:pt-36 sm:pb-20 overflow-hidden">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[300px] bg-[#7c3aed]/[0.05] rounded-full pointer-events-none" />
            ...
            <motion.div className="grid grid-cols-2 sm:grid-cols-4 gap-4" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              {[{ n: "4", l: "intensive sessions" }, { n: "8+", l: "templates" }, { n: "10h", l: "mentor support" }, { n: "1", l: "production agent" }].map((s) => (
                <motion.div key={s.l} variants={fadeInUp} className="glass border border-[var(--color-glass-border)] rounded-2xl p-6 text-center">
                  <div className="text-4xl font-display font-bold" style={{ background: "linear-gradient(135deg,#c084fc,#a855f7)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>{s.n}</div>
        ...
        <CourseBookingForm
          startDate="Sep 8"
          telegramHref="https://t.me/vladyslavarcher?text=Hello! I want to join AI Voice Agent (Sep 8, €39)."
        />
        ...
        <section className="py-16 border-t border-[var(--color-glass-border)]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { title: "Voice Agents with Vapi", sub: "Latency, barge-in, grounding" },
                { title: "Evaluating LLM Systems", sub: "Quality, safety, costs" },
                { title: "Shipping AI Agents", sub: "Traces, retries, guardrails" },
              ].map((r) => (
                <Link key={r.title} href="/blog" className="glass border border-[var(--color-glass-border)] rounded-xl p-5 hover:border-[#7c3aed]/40 transition-all group">
