      ...
      <main className="pt-28 sm:pt-36 pb-20">
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass border border-[var(--color-glass-border)] rounded-2xl p-8 sm:p-10">
            <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#a855f7]/10 border border-[#a855f7]/25 text-[#c084fc] text-xs font-medium uppercase tracking-wider mb-6">
              Legal
            </span>
