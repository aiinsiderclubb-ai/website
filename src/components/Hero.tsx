      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-32">
        ...
        >
          <motion.div variants={fadeInUp} custom={0} className="mb-6">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#a855f7]/15 to-[#f97316]/10 border border-[#a855f7]/30 text-[#c084fc] text-xs font-medium tracking-wider uppercase backdrop-blur-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-[#a855f7] animate-pulse-glow shadow-[0_0_8px_#a855f7]" />
              {t.hero.badge}
            </span>
          </motion.div>
          ...
          >
            <a
              href="/courses"
              className="group inline-flex items-center justify-center px-7 py-3.5 bg-gradient-to-r from-[#a855f7] via-[#c084fc] to-[#f97316] text-white font-medium rounded-full shadow-[0_0_28px_rgba(168,85,247,0.35)] hover:shadow-[0_0_40px_rgba(249,115,22,0.45)] transition-all duration-300 text-sm"
            >
