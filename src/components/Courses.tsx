...
import { getCourses } from "@landing/data/content";
          ...
          {courses.map((course, i) => (
            <motion.div
              ...
              className={`group glass-card rounded-2xl overflow-hidden transition-all duration-500 flex flex-col ${
                course.featured
                  ? "border-[#a855f7]/35 ring-1 ring-[#a855f7]/20"
                  : ""
              }`}
            >
              {course.featured && (
                <div className="bg-gradient-to-r from-[#a855f7] to-[#f97316] text-center py-1.5 text-xs font-semibold text-white tracking-wider uppercase">
                  VIP
                </div>
              )}
              ...
              <div className="p-6 sm:p-8 flex-1 flex flex-col">
                ...
                <Link
                  ...
                  className={`block text-center py-3 rounded-xl text-sm font-medium transition-all duration-300 ${
                    course.featured
                      ? "bg-gradient-to-r from-[#a855f7] to-[#f97316] text-white hover:shadow-[0_0_24px_rgba(14,165,233,0.3)]"
                      : "card-btn-secondary"
                  }`}
                >
                  {course.ctaText}
