...
function getServices(t: ReturnType<typeof useI18n>["t"]) {
  return [
    {
      id: "influencer",
      icon: (
      ...
      label: t.aiContentStudio.influencerLabel,
      sublabel: t.aiContentStudio.influencerSublabel,
      metric: "3M+",
      metricLabel: t.aiContentStudio.influencerMetricLabel,
      preview: {
        engagement: "+340%",
        content: "500+",
        savings: "80%",
    ...
    },
    {
      ...
      label: t.aiContentStudio.videoLabel,
      sublabel: t.aiContentStudio.videoSublabel,
      metric: "500+",
      metricLabel: t.aiContentStudio.videoMetricLabel,
      preview: {
        engagement: "+210%",
        content: "500+",
        savings: "70%",
    ...
    },
    {
      ...
      label: t.aiContentStudio.ugcLabel,
      sublabel: t.aiContentStudio.ugcSublabel,
      metric: "80%",
      metricLabel: t.aiContentStudio.ugcMetricLabel,
      preview: {
        engagement: "+180%",
        content: "200+",
        savings: "80%",
    ...
    },
    {
      ...
      label: t.aiContentStudio.creativeLabel,
      sublabel: t.aiContentStudio.creativeSublabel,
      metric: "100+",
      metricLabel: t.aiContentStudio.creativeMetricLabel,
      preview: {
        engagement: "+120%",
        content: "100+",
        savings: "90%",
...
type Service = ReturnType<typeof getServices>[0];

function PhoneMockup({ activeService, t }: { activeService: Service; t: ReturnType<typeof useI18n>["t"] }) {
  return (
    <div className="relative flex items-center justify-center">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-8 left-4 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-red-500 z-10">
            ...
            <span className="text-[10px] font-bold text-white tracking-wider">{t.aiContentStudio.live}</span>
          </div>
          ...
          <div className="absolute bottom-28 left-3 flex items-center gap-1.5 px-2.5 py-1 rounded-full z-10"
            ...
            <span className="text-[10px] font-bold text-white">{activeService.label.split(" ").slice(0, 2).join(" ")}</span>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 z-10"
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <div>
                <div className="text-white text-[11px] font-semibold">{t.aiContentStudio.aiCreator}</div>
                <div className="text-white/50 text-[9px]">2.5M {t.aiContentStudio.followers}</div>
              </div>
            </div>
            <p className="text-white/60 text-[9px]">{t.aiContentStudio.createsContent}</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-1.5 mb-3">
          ...
          <span className="text-[10px] text-white font-semibold">{t.aiContentStudio.influencerLabel}</span>
        </div>

        <div className="text-[8px] text-white/40 uppercase tracking-wider mb-2">{t.aiContentStudio.metricsLabel}</div>
        <div className="space-y-1.5">
          {[
            { label: t.aiContentStudio.engagement, value: activeService.preview.engagement, color: "#22c55e" },
            { label: t.aiContentStudio.contentMonth, value: activeService.preview.content, color: "white" },
            { label: t.aiContentStudio.statSavings, value: activeService.preview.savings, color: activeService.color },
          ].map((row) => (
...
export default function AIContentStudio() {
  ...
  const bottomStats = [
    { value: "10x", label: t.aiContentStudio.statContent },
    { value: "80%", label: t.aiContentStudio.statSavings },
    { value: "10+", label: t.aiContentStudio.statLanguages },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            >
              {t.aiContentStudio.title}{" "}
              <span className="gradient-text">{t.aiContentStudio.titleHighlight}</span>
            </motion.h2>
            ...
            <motion.div variants={fadeInUp} custom={4} className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              >
                ...
                <span className="relative">{t.aiContentStudio.learnMore}</span>
              ...
              <button className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl text-sm font-medium text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] border border-[var(--color-glass-border)] hover:border-[var(--color-accent-border)] transition-all duration-300">
                ...
                {t.aiContentStudio.watchExamples}
              </button>
            </motion.div>
          ...
          >
            <AnimatePresence mode="wait">
              <PhoneMockup key={activeIdx} activeService={activeService} t={t} />
            </AnimatePresence>
          </motion.div>
        </div>
      </div>
