...
export default function Footer() {
  ...
  return (
    <footer className="footer-dark relative overflow-hidden">
      ...
      {/* ── Glow orbs ── */}
      <div className="absolute top-0 left-1/4 w-[420px] h-[420px] hidden md:block rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(14,165,233,0.06) 0%, transparent 70%)" }} />
      <div className="absolute bottom-0 right-1/4 w-[360px] h-[360px] hidden md:block rounded-full pointer-events-none"
            ...
            <Link href="/" className="inline-flex items-center gap-3 group">
              <div className="relative w-11 h-11 rounded-xl overflow-hidden">
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, #a855f7, #c084fc, #f97316)" }}
                />
                  ...
                  {links.map((link) => (
                    <li key={link.label}>
                      {"external" in link && link.external ? (
                        ...
                        >
                          <span
                            className="w-1 h-1 rounded-full shrink-0 transition-colors group-hover:bg-[#a855f7]"
