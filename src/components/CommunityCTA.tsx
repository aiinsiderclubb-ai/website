...
export default function CommunityCTA() {
  ...
  return (
    <section id="community" className="section-padding relative overflow-hidden">
      ...
      <div className="community-ribbon-stream" aria-hidden />
        ...
        >
          ...
          <motion.div variants={fadeInUp} custom={3}>
            <a
              ...
              className="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#a855f7] to-[#f97316] text-white font-medium rounded-full hover:shadow-[0_0_30px_rgba(14,165,233,0.35)] transition-all duration-300 text-sm"
            >
