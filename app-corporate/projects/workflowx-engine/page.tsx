...
import { 
  ArrowLeft, Zap, Layers, Clock, TrendingDown, CheckCircle2,
  Database, RefreshCw, Shield, Plug, Settings, BarChart3
} from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Connect with popular tools like SAP, Oracle, Salesforce, and custom APIs.',
  },
  {
    icon: RefreshCw,
    title: 'Event-Driven Workflows',
    description: 'Triggers that respond to real-time events across your entire tech stack.',
  },
  {
    icon: Database,
    title: 'Data Transformation',
    description: 'Automatic formatting and validation as data flows between systems.',
  },
  {
    icon: Shield,
    title: 'Error Handling',
    description: 'Intelligent retry logic and fallback procedures for mission-critical workflows.',
  },
  {
    icon: Settings,
    title: 'No-Code Builder',
    description: 'Visual workflow designer for business users to create automations.',
  },
  {
    icon: BarChart3,
    title: 'Audit Trail',
    description: 'Complete visibility into every action with compliance-ready logging.',
  },
];

const results = [
  { value: '50+', label: 'Tools Connected', icon: Plug },
  { value: '-90%', label: 'Manual Work', icon: Clock },
  { value: '-95%', label: 'Error Rate', icon: TrendingDown },
  { value: '24/7', label: 'Uptime', icon: CheckCircle2 },
];

const connectedTools = [
  'SAP', 'Oracle', 'Salesforce', 'NetSuite', 'Workday', 'ServiceNow',
  'Jira', 'Slack', 'Teams', 'AWS', 'Azure', 'Custom APIs'
];

export default function WorkflowXEnginePage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Enterprise workflow automation platform connecting 50+ tools. 
                Reduced manual data entry by 90% for a major logistics company.
              </p>

              <div className="flex flex-wrap gap-3 mb-8">
                {['Automation', 'Enterprise', 'Integration', 'Logistics', 'API'].map((tag) => (
